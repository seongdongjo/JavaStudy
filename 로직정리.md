...
허나, - _ . ! ~ * ' ( ) 문자들은 희한하게 VO에 보면 &apos%41%42 이렇게 거꾸로 인코딩이 되어 들어가있다.
...
function junpyoCreate() {
	...
	qcell.setCellDisable(selectedRow,15,true)
	qcell.setCellDisable(selectedRow,16,true)
...
<select id="checkMaeclSlipMng" parameterType="TRSlipMngVO" resultType="String">
	SELECT COUNT(*) AS CNT FROM TRCTAX WHERE ISSUE_DATE=#{schSlipDate} ANDTAX_FINISH_YN='N' ORDER BY TAX_NO
</select>
